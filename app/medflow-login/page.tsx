    ...
    <main style={{ minHeight:'100vh', background:'#04080F', fontFamily:"'Outfit',sans-serif", display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'32px 16px', position:'relative', overflow:'hidden' }}>
      ...
      <div style={{ width:'100%', maxWidth: tab==='signup' && step==='plan' ? 900 : 440, transition:'max-width 0.3s ease' }}>
        ...
        <div style={{ textAlign:'center', marginBottom:28 }}>
          <div style={{ width:52, height:52, borderRadius:14, background:'linear-gradient(135deg,#0A6E68,#14D2C2)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:24, margin:'0 auto 12px' }}>âš•</div>
        ...
        {tab === 'signin' && (
          <div style={{ background:'#0B1826', border:'1px solid #152840', borderRadius:18, padding:32 }}>
            ...
            <div style={{ marginTop:20, textAlign:'center' }}>
              ...
              <button onClick={()=>setTab('signup')} style={{ background:'none', border:'none', color:'#14D2C2', fontSize:12, cursor:'pointer', fontWeight:600 }}>View plans â†’</button>
            </div>
          </div>
        )}
        ...
        {tab === 'signup' && step === 'account' && (
          <div style={{ background:'#0B1826', border:'1px solid #152840', borderRadius:18, padding:32 }}>
            ...
            <button onClick={()=>setStep('plan')} style={{ width:'100%', padding:'10px', borderRadius:11, background:'transparent', border:'1px solid #152840', color:'#4A7090', fontSize:13, cursor:'pointer', fontFamily:"'Outfit',sans-serif" }}>â† Back to plan selection</button>
        ...
        <div style={{ marginTop:20, textAlign:'center' }}>
          <button onClick={()=>router.push('/')} style={{ background:'transparent', border:'none', color:'#2E5070', fontSize:11, fontFamily:"'Geist Mono',monospace", cursor:'pointer', letterSpacing:1.5 }}>â† BACK TO PLATFORM SELECT</button>
        </div>
